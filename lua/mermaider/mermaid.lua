...
local ui = require("mermaider.ui") -- Add this to use the UI module

-- Preview a rendered mermaid diagram using image.nvim in a split window
...
function M.preview_diagram(bufnr, image_path, config)
  ...
  vim.schedule(function()
    ...
    -- Clear the previous image before rendering the new one
